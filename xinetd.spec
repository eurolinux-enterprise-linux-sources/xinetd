...
Patch11: xinetd-2.3.14-poll.v2.patch
...
Patch18: xinetd-2.3.14-signal-log-hang.patch
Patch19: xinetd-2.3.14-fix-type-punned-ptr.patch
...
mkdir -m 0700 -p $RPM_BUILD_ROOT/etc/xinetd.d/
...
* Tue Sep 20 2011 Vojtech Vitek (V-Teq) <vvitek@redhat.com> - 2:2.3.14-33
- Remove /etc/xinetd.d/ directory ownership (bz#738662)

* Fri Aug 12 2011 Vojtech Vitek (V-Teq) <vvitek@redhat.com> - 2:2.3.14-32
- restrict config file r/w permissions only for root (#706976)
